...
<head>
	...
	<link rel="stylesheet" href="{{ asset ('fontend/css/prettyPhoto.css')}}">
	<link rel="stylesheet" href="{{ asset ('fontend/css/css/price-range.css')}}">
					...
					<div class="col-sm-9">
						...
						<div class="mainmenu pull-left">
							<ul class="nav navbar-nav collapse navbar-collapse">
								<li><a href="{{URL::to('/Trang-Chủ')}}" class="active">Home</a></li>
